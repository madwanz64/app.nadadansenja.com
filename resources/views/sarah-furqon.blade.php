...
<div id="main" class="-z-10">
    <div class="max-w-md mx-auto bg-white relative">
        ...
        <div id="acara" class=" bg-white bg-cover flex flex-col text-center mt-8 py-16 text-[#701651] relative">
            ...
            <a target="_blank" href="https://calendar.google.com/calendar/u/0/r/eventedit/NjBiN2d2bGE4M29tOWswdjhwa2Q3a3V0M2UgMTc3MmU4Y2ExNTVkNjA2ZDlkMWFmZGRkNjdmNTUwMmY3YWM5OGIyYzUxNTgzYzFkMjZkMWQwNmYwMmY2ZmFlOUBn" class="w-80 bg-[#701651] mx-auto mt-4 py-1 text-white rounded-2xl">Ingatkan via Google Calendar</a>
